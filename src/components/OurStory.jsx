    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row bg-customLightPink p-8">
                ...
                <div className="flex flex-col justify-center text-white w-full md:w-2/3 p-4">
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-center md:text-left">Welcome to Toronto Cupcake!</h2>
